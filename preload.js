...
contextBridge.exposeInMainWorld('api', {
  ...
  loadSession: (source) => ipcRenderer.invoke('session:load', source),
  saveSession: (source, session) => ipcRenderer.sendSync('session:save', { source, session }),
  confirmReplaceCuts: () => ipcRenderer.invoke('dialog:replaceCuts'),
